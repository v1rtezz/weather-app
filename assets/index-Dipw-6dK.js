(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const c of s.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&o(c)}).observe(document,{childList:!0,subtree:!0});function i(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(r){if(r.ep)return;r.ep=!0;const s=i(r);fetch(r.href,s)}})();const h={API_BASE_URL:"https://api.openweathermap.org/data/2.5/forecast",API_KEY:"11cdf37009d6cf0b79c8c8a1094ec724"};class f{modal;modalClassActive;openBtn;closeBtn;noScroll;body=document.body;constructor(t,i,o,r,s){this.modalClassActive=r,this.noScroll=s;const c=document.querySelector(t),u=document.querySelector(i),p=document.querySelector(o);if(!c||!u||!p)throw new Error("Modal: один из селекторов не нашёл элемент в DOM");this.modal=c,this.openBtn=u,this.closeBtn=p}init(){this.openBtn.addEventListener("click",()=>this.toggle()),this.closeBtn.addEventListener("click",()=>this.toggle()),this.body.addEventListener("keydown",t=>{(t.code==="Escape"||t.code==="Backspace")&&this.toggle()})}toggle(){this.modal.classList.toggle(this.modalClassActive),this.body.classList.toggle(this.noScroll)}}class g{API_URL;constructor(t){this.API_URL=t}async getData(){const t=await fetch(this.API_URL);return console.log(this.API_URL),await t.json()}}const a=e=>Math.ceil(e);function l(e){const t=new Date(e*1e3),i=t.getHours().toString().padStart(2,"0"),o=t.getMinutes().toString().padStart(2,"0");return`${i}:${o}`}const v=e=>`
...
<img src="https://openweathermap.org/img/wn/${e.list[0].weather[0].icon}@2x.png" alt="" />          </div>
        ...
        <div class="current__weather-description">
         ...
         <div class="current__weather-description">
          <p>Восход: ${l(e.city.sunrise)}</p>
        </div>
         <div class="current__weather-description">
          <p>Закат: ${l(e.city.sunset)}</p>
        </div>
      ...
      `,_=e=>{document.querySelector("[data-app]")?.insertAdjacentHTML("beforeend",v(e))},m=e=>`
   <div class="hours-forecast-card forecast-card">
            <div>
              <h3 class="hours-forecast-title forecast-card-title">${l(e.dt)}</h3>
...
<img src="https://openweathermap.org/img/wn/${e.weather[0].icon}@2x.png" alt="" />          </div>
  ...
  `,w=e=>{const t=document.querySelector("[data-app]");if(!t)return;t.insertAdjacentHTML("beforeend",`
      ...
      </section>`);const i=document.querySelector("[data-hours-forecast-cards]");if(i)for(let o=0;o<6;o++)i.insertAdjacentHTML("beforeend",m(e.list[o]))},y=e=>`
...
<img src="https://openweathermap.org/img/wn/${e.weather[0].icon}@2x.png" alt="" />          </div>
  ...
  `,C=e=>{const t=document.querySelector("[data-app]");if(!t)return;t.insertAdjacentHTML("beforeend",`
    <section class="days-forecast">
        ...
        ></div>
      </section>`);const i=document.querySelector("[data-days-forecast-cards]");if(!i)return;e.list.filter(r=>r.dt_txt.includes("12:00:00")).forEach(r=>{i.insertAdjacentHTML("beforeend",y(r))})},d=document.querySelector("[data-app]"),S=e=>{if(!d)return;e.list?.[0]?.sys?.pod==="d"?d.insertAdjacentHTML("beforeend",`<svg class="time-indicator" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
      ...
      </svg>`):d.insertAdjacentHTML("beforeend",'<svg class="time-indicator" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M3.32031 11.6835C3.32031 16.6541 7.34975 20.6835 12.3203 20.6835C16.1075 20.6835 19.3483 18.3443 20.6768 15.032C19.6402 15.4486 18.5059 15.6834 17.3203 15.6834C12.3497 15.6834 8.32031 11.654 8.32031 6.68342C8.32031 5.50338 8.55165 4.36259 8.96453 3.32996C5.65605 4.66028 3.32031 7.89912 3.32031 11.6835Z" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>')},L=new f("[data-settings-modal]","[data-open-settings-modal]","[data-close-settings-modal]","settings-window--active","no-scroll");L.init();const M=encodeURIComponent("Москва"),A=`${h.API_BASE_URL}?q=${M}&appid=${h.API_KEY}&units=metric&lang=ru`,b=new g(A),n=await b.getData();_(n);w(n);C(n);S(n);
