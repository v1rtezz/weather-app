var w=Object.defineProperty;var v=(i,t,e)=>t in i?w(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var a=(i,t,e)=>v(i,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const n of s)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&r(o)}).observe(document,{childList:!0,subtree:!0});function e(s){const n={};return s.integrity&&(n.integrity=s.integrity),s.referrerPolicy&&(n.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?n.credentials="include":s.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function r(s){if(s.ep)return;s.ep=!0;const n=e(s);fetch(s.href,n)}})();class _{constructor(t,e,r,s,n){a(this,"modal");a(this,"modalClassActive");a(this,"openBtn");a(this,"closeBtn");a(this,"noScroll");a(this,"body",document.body);this.modalClassActive=s,this.noScroll=n;const o=document.querySelector(t),c=document.querySelector(e),d=document.querySelector(r);if(!o)throw new Error(`Modal: не найден элемент по селектору "${t}"`);if(!c)throw new Error(`Modal: не найден элемент по селектору "${e}"`);if(!d)throw new Error(`Modal: не найден элемент по селектору "${r}"`);if(!o||!c||!d)throw new Error("Modal: один из селекторов не нашёл элемент в DOM");this.modal=o,this.openBtn=c,this.closeBtn=d}init(){this.openBtn.addEventListener("click",()=>this.toggle()),this.closeBtn.addEventListener("click",()=>this.toggle()),this.body.addEventListener("keydown",t=>{t.code==="Escape"&&this.toggle()})}toggle(){this.modal.classList.toggle(this.modalClassActive),this.body.classList.toggle(this.noScroll)}}class l{constructor(t,e,r){a(this,"element");this.element=document.createElement(t),this.element.className=e,r&&this.element.setAttribute(r,"")}}class f extends l{constructor(){super("header","header")}createElement(){this.element.innerHTML=` <button class="open-settings" data-open-settings-modal>
            <svg
              version="1.1"
              id="_x32_"
          ...
          `}render(){return this.createElement(),this.element}}class y extends l{constructor(t,e){super(t,e)}render(){return this.element}}class b{constructor(t){a(this,"element");this.element=document.createElement("main"),this.element.className=t;const e=new y("div","container").render();this.element.append(e)}}class h extends Error{constructor(t,e,r,s){super(`Http error ${t}: ${e}`),this.statusCode=t,this.statusText=e,this.responseBody=r,this.response=s}}const u={API_URL:"https://api.openweathermap.org",API_KEY:"11cdf37009d6cf0b79c8c8a1094ec724"};class C{constructor({baseUrl:t,headers:e,apiKey:r}){a(this,"baseUrl");a(this,"defaultHeaders");a(this,"apiKey");this.baseUrl=t,this.defaultHeaders=e||{},this.apiKey=r}async request(t,e={},r){const s=this.baseUrl+t+(r?`&appid=${r}`:""),n={...this.defaultHeaders,...e.headers||{}},o=await fetch(s,{...e,headers:n}),c=await o.json();if(!o.ok)throw new h(o.status,o.statusText,c,o);return c}get(t,e={}){return this.request(t,{...e,method:"GET"},this.apiKey)}}const S=new C({baseUrl:u.API_URL,apiKey:u.API_KEY});class g{static async get(t){const e=encodeURIComponent(t.trim());return await S.get(`/data/2.5/forecast?q=${e}&units=metric&lang=ru`)}}class x extends l{constructor(t){super("section","search"),this.onSearch=t}createElement(){this.element.innerHTML=` <form class="search__form" data-search-form>
...
`}render(){return this.createElement(),this.element}}class E extends b{constructor(){super("main");a(this,"data",null)}async getDataFromLocalstorage(){try{const e=localStorage.getItem("currentCity");if(!e)return;const r=await g.get(e);if(!r)return;this.data=r}catch(e){e instanceof h&&console.error(e.message)}}async createPage(){const e=this.element.querySelector(".container");this.appendSearch(e),await this.getDataFromLocalstorage(),this.data&&this.appendCurrentWeather(e)}updateCurrentWeather(e){const r=e.querySelector(".current");r&&r.remove(),this.data&&e.append(new m(this.data).render())}appendSearch(e){const r=new x(s=>{this.data=s,this.updateCurrentWeather(e)});e.append(r.render())}async appendCurrentWeather(e){e.append(new m(this.data).render())}async render(){return await this.createPage(),this.element}}class L extends l{constructor(){super("div","settings-window","data-settings-modal")}createElement(){this.element.innerHTML=`
