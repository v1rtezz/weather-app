var E=Object.defineProperty;var S=(n,t,e)=>t in n?E(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var o=(n,t,e)=>S(n,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function e(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(s){if(s.ep)return;s.ep=!0;const a=e(s);fetch(s.href,a)}})();class d{constructor(t,e,r){o(this,"element");this.element=document.createElement(t),this.element.className=e,r&&this.element.setAttribute(r,"")}}class M extends d{constructor(){super("header","header")}createElement(){this.element.innerHTML=` 
          <img
            class="logo"
            src="./logo.png"
            alt=""
          ...
          `}render(){return this.createElement(),this.element}}class b extends d{constructor(t,e){super(t,e)}render(){return this.element}}class L{constructor(t){o(this,"element");this.element=document.createElement("main"),this.element.className=t;const e=new b("div","container").render();this.element.append(e)}}class u extends Error{constructor(t,e,r,s){super(`Http error ${t}: ${e}`),this.statusCode=t,this.statusText=e,this.responseBody=r,this.response=s}}const h={API_URL:"https://api.openweathermap.org",API_KEY:"11cdf37009d6cf0b79c8c8a1094ec724",FEATURES_KEY:"favoriteCities"};class x{constructor({baseUrl:t,headers:e,apiKey:r}){o(this,"baseUrl");o(this,"defaultHeaders");o(this,"apiKey");this.baseUrl=t,this.defaultHeaders=e||{},this.apiKey=r}async request(t,e={},r){const s=this.baseUrl+t+(r?`&appid=${r}`:""),a={...this.defaultHeaders,...e.headers||{}},i=await fetch(s,{...e,headers:a}),c=await i.json();if(!i.ok)throw new u(i.status,i.statusText,c,i);return c}get(t,e={}){return this.request(t,{...e,method:"GET"},this.apiKey)}}const T=new x({baseUrl:h.API_URL,apiKey:h.API_KEY});class m{static async get(t){const e=encodeURIComponent(t.trim());return await T.get(`/data/2.5/forecast?q=${e}&units=metric&lang=ru`)}}class k extends d{constructor(t,e){super("section","search"),this.onSearch=t,this.onError=e}createElement(){this.element.innerHTML=` <form class="search__form" data-search-form>
        ...
        <p class="form-message" data-form-message></p>`,this.element.querySelector("[data-search-form]").addEventListener("submit",this.handleSubmit.bind(this))}async handleSubmit(t){t.preventDefault();const e=this.element.querySelector("[data-search-input]"),r=this.element.querySelector("[data-form-message]");r.innerHTML="";const s=e.value.trim();if(s.length===0){r.textContent="Проверка на дурака прошла успешно",this.onError();return}try{const a=await m.get(s);this.onSearch(a),localStorage.setItem("currentCity",s)}catch(a){a instanceof u&&(this.onError(),r.textContent="Окак, видать твоего города у нас нет, сорян. Текст ошибки:"+a.message)}}render(){return this.createElement(),this.element}}function p(n){const t=new Date(n*1e3),e=t.getHours().toString().padStart(2,"0"),r=t.getMinutes().toString().padStart(2,"0");return`${e}:${r}`}const{FEATURES_KEY:f}=h,l=()=>{const n=localStorage.getItem(f);return n?JSON.parse(n):[]},D=n=>{const t=l();t.includes(n)||localStorage.setItem(f,JSON.stringify([...t,n]))},H=n=>{const t=l().filter(e=>e!==n);localStorage.setItem(f,JSON.stringify(t))};class $ extends d{constructor(t){super("button","features__card"),this.city=t}async createElement(){const t=await m.get(this.city),e=t.list[0],r=t.list.find(a=>a.pop&&a.pop>0),s=r?`${Math.ceil(r.pop*100)}%`:"Нет данных";this.element.innerHTML=`
  ...
  Вероятность дождя: ${s}
    ...
    `;const e=this.element.querySelector("[data-features-cards]");e&&this.featuresList.forEach(r=>{const a=new $(r).render();a.addEventListener("click",()=>{var i;(i=this.onCityClick)==null||i.call(this,r)}),e.append(a)})}render(){return this.createElement(),this.element}}class w extends d{constructor(t=null){super("section","current","data-current-weather"),this.data=t}async createElement(){if(!this.data){this.element.innerHTML="<p>Ошибка загрузки данных</p>";return}const t=this.data.list.find(s=>s.pop&&s.pop>0),e=t?`${Math.ceil(t.pop*100)}%`:"Нет данных";this.element.innerHTML=`
...
`;const r=this.element.querySelector(".current__btn");r&&r.addEventListener("click",()=>{var g;if(!this.data)return;const s=this.data.city.name;r.classList.contains("current__btn--active")?(H(s),r.classList.remove("current__btn--active"),console.log(`Удалён из избранного: ${s}`)):(D(s),r.classList.add("current__btn--active"),console.log(`Добавлен в избранное: ${s}`));const i=document.querySelector("[data-features]");i&&i.remove();const c=new C().render();(g=document.querySelector("[data-app]"))==null||g.append(c)}),r&&this.data&&l().includes(this.data.city.name)&&r.classList.add("current__btn--active")}render(){return this.createElement(),this.element}}class W extends d{constructor(t){super("div","hours-forecast-card forecast-card"),this.snapshot=t}async createElement(){this.element.innerHTML=`
      <div>
