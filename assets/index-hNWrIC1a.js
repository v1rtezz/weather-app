var S=Object.defineProperty;var E=(n,t,e)=>t in n?S(n,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):n[t]=e;var d=(n,t,e)=>E(n,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))r(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function e(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function r(s){if(s.ep)return;s.ep=!0;const a=e(s);fetch(s.href,a)}})();class c{constructor(t,e,r){d(this,"element");this.element=document.createElement(t),this.element.className=e,r&&this.element.setAttribute(r,"")}}class M extends c{constructor(){super("header","header")}createElement(){this.element.innerHTML=` 
          ...
          `}render(){return this.createElement(),this.element}}class b extends c{constructor(t,e){super(t,e)}render(){return this.element}}class L{constructor(t){d(this,"element");this.element=document.createElement("main"),this.element.className=t;const e=new b("div","container").render();this.element.append(e)}}class u extends Error{constructor(t,e,r,s){super(`Http error ${t}: ${e}`),this.statusCode=t,this.statusText=e,this.responseBody=r,this.response=s}}const h={API_URL:"https://api.openweathermap.org",API_KEY:"11cdf37009d6cf0b79c8c8a1094ec724",FEATURES_KEY:"favoriteCities"};class x{constructor({baseUrl:t,headers:e,apiKey:r}){d(this,"baseUrl");d(this,"defaultHeaders");d(this,"apiKey");this.baseUrl=t,this.defaultHeaders=e||{},this.apiKey=r}async request(t,e={},r){const s=this.baseUrl+t+(r?`&appid=${r}`:""),a={...this.defaultHeaders,...e.headers||{}},i=await fetch(s,{...e,headers:a}),o=await i.json();if(!i.ok)throw new u(i.status,i.statusText,o,i);return o}get(t,e={}){return this.request(t,{...e,method:"GET"},this.apiKey)}}const T=new x({baseUrl:h.API_URL,apiKey:h.API_KEY});class m{static async get(t){const e=encodeURIComponent(t.trim());return await T.get(`/data/2.5/forecast?q=${e}&units=metric&lang=ru`)}}class D extends c{constructor(t,e){super("section","search"),this.onSearch=t,this.onError=e}createElement(){this.element.innerHTML=` <form class="search__form" data-search-form>
        ...
        <p class="form-message" data-form-message></p>`,this.element.querySelector("[data-search-form]").addEventListener("submit",this.handleSubmit.bind(this))}async handleSubmit(t){t.preventDefault();const e=this.element.querySelector("[data-search-input]"),r=this.element.querySelector("[data-form-message]");r.innerHTML="";const s=e.value.trim();if(s.length===0){r.textContent="Проверка на дурака прошла успешно",this.onError();return}try{const a=await m.get(s);this.onSearch(a),localStorage.setItem("currentCity",s)}catch(a){a instanceof u&&(this.onError(),r.textContent="Окак, видать твоего города у нас нет, сорян. Текст ошибки:"+a.message)}}render(){return this.createElement(),this.element}}function p(n){const t=new Date(n*1e3),e=t.getHours().toString().padStart(2,"0"),r=t.getMinutes().toString().padStart(2,"0");return`${e}:${r}`}const{FEATURES_KEY:f}=h,l=()=>{const n=localStorage.getItem(f);return n?JSON.parse(n):[]},k=n=>{const t=l();t.includes(n)||localStorage.setItem(f,JSON.stringify([...t,n]))},H=n=>{const t=l().filter(e=>e!==n);localStorage.setItem(f,JSON.stringify(t))};class $ extends c{constructor(t){super("button","features__card"),this.city=t}async createElement(){const t=await m.get(this.city),e=t.list[0],r=t.list.find(a=>a.pop&&a.pop>0),s=r?`${Math.ceil(r.pop*100)}%`:"Нет данных";this.element.innerHTML=`
  ...
  Вероятность дождя: ${s}
    ...
    `;const e=this.element.querySelector("[data-features-cards]");e&&this.featuresList.forEach(r=>{const a=new $(r).render();a.addEventListener("click",()=>{var i;(i=this.onCityClick)==null||i.call(this,r)}),e.append(a)})}render(){return this.createElement(),this.element}}class w extends c{constructor(t=null){super("section","current","data-current-weather"),this.data=t}async createElement(){if(!this.data){this.element.innerHTML="<p>Ошибка загрузки данных</p>";return}const t=this.data.list.find(s=>s.pop&&s.pop>0),e=t?`${Math.ceil(t.pop*100)}%`:"Нет данных";this.element.innerHTML=`
...
<label class="switch">
  ...
  <span class="slider"></span>
    ...
    `;const t=this.element.querySelector("input"),e=document.body,r=i=>{e.setAttribute("data-theme",i),localStorage.setItem("theme",i),t.checked=i==="dark"},a=localStorage.getItem("theme")??"light";r(a),t==null||t.addEventListener("change",()=>{const i=t.checked?"dark":"light";r(i)})}render(){return this.createElement(),this.element}}class R extends L{constructor(){super("main");d(this,"CITY_KEY","currentCity");d(this,"data",null);d(this,"selectedDt",null)}async getDataFromLocalstorage(){const e=localStorage.getItem(this.CITY_KEY);e&&await this.fetchData(e)}async fetchData(e){try{const r=await m.get(e);if(!r)return;this.data=r}catch(r){r instanceof u&&console.error(r.message)}}async createPage(){const e=this.element;this.appendSearch(e),await this.getDataFromLocalstorage(),this.data&&(this.renderFullWeather(e),this.appendTimeIndicator(e),this.appendThemeSwitcher(e))}updateCurrentWeather(e){this.clearWeather(e),this.data&&this.renderFullWeather(e)}appendSearch(e){const r=new D(s=>{this.data=s,this.updateCurrentWeather(e)},()=>this.clearWeather(e));e.append(r.render())}renderFullWeather(e){this.clearWeather(e),this.appendCurrentWeather(e),this.appendCurrentHoursWeather(e),this.appendCurrentDaysWeather(e),this.appendFeatures(e),this.appendTimeIndicator(e)}clearWeather(e){["[data-current-weather]","[data-current-hours-weather]","[data-current-days-weather]","[data-features]","[data-time-indicator]"].forEach(s=>{const a=e.querySelector(s);a&&a.remove()})}async appendCurrentWeather(e){e.append(new w(this.data).render())}async appendCurrentHoursWeather(e){e.append(new v(this.data).render())}async appendThemeSwitcher(e){e.append(new I().render())}appendFeatures(e){const r=e.querySelector("[data-features]");r&&r.remove();const s=new C(async a=>{localStorage.setItem(this.CITY_KEY,a),await this.fetchData(a),this.renderFullWeather(e)});e.append(s.render())}appendTimeIndicator(e){e.append(new F(this.data).render())}async appendCurrentDaysWeather(e){const r=new y(this.data,s=>{this.selectedDt=s,this.updateCurrentWeatherForDay(e,s)},this.selectedDt??void 0);e.append(r.render())}updateCurrentWeatherForDay(e,r){if(!this.data)return;const s=new Date(r*1e3),a=this.data.list.filter(i=>{const o=new Date(i.dt*1e3);return o.getFullYear()===s.getFullYear()&&o.getMonth()===s.getMonth()&&o.getDate()===s.getDate()});a.length!==0&&(this.selectedDt=r,this.clearWeather(e),e.append(new w({...this.data,list:a}).render()),e.append(new v({...this.data,list:a}).render()),e.append(new y(this.data,i=>this.updateCurrentWeatherForDay(e,i),this.selectedDt).render()),this.appendFeatures(e),this.appendTimeIndicator(e),this.appendThemeSwitcher(e))}async render(){return await this.createPage(),this.element}}class V{constructor(){d(this,"root");this.root=document.querySelector("[data-app]")}async init(){this.root.append(new M().render()),this.root.append(await new R().render())}}new V().init();
