var w=Object.defineProperty;var v=(i,t,e)=>t in i?w(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var a=(i,t,e)=>v(i,typeof t!="symbol"?t+"":t,e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function e(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=e(r);fetch(r.href,n)}})();class _{constructor(t,e,s,r,n){a(this,"modal");a(this,"modalClassActive");a(this,"openBtn");a(this,"closeBtn");a(this,"noScroll");a(this,"body",document.body);this.modalClassActive=r,this.noScroll=n;const o=document.querySelector(t),c=document.querySelector(e),d=document.querySelector(s);if(!o)throw new Error(`Modal: не найден элемент по селектору "${t}"`);if(!c)throw new Error(`Modal: не найден элемент по селектору "${e}"`);if(!d)throw new Error(`Modal: не найден элемент по селектору "${s}"`);if(!o||!c||!d)throw new Error("Modal: один из селекторов не нашёл элемент в DOM");this.modal=o,this.openBtn=c,this.closeBtn=d}init(){this.openBtn.addEventListener("click",()=>this.toggle()),this.closeBtn.addEventListener("click",()=>this.toggle()),this.body.addEventListener("keydown",t=>{t.code==="Escape"&&this.toggle()})}toggle(){this.modal.classList.toggle(this.modalClassActive),this.body.classList.toggle(this.noScroll)}}class l{constructor(t,e,s){a(this,"element");this.element=document.createElement(t),this.element.className=e,s&&this.element.setAttribute(s,"")}}class f extends l{constructor(){super("header","header")}createElement(){this.element.innerHTML=` <button class="open-settings" data-open-settings-modal>
            <svg
              version="1.1"
              id="_x32_"
          ...
          `}render(){return this.createElement(),this.element}}class y extends l{constructor(t,e){super(t,e)}render(){return this.element}}class b{constructor(t){a(this,"element");this.element=document.createElement("main"),this.element.className=t;const e=new y("div","container").render();this.element.append(e)}}class h extends Error{constructor(t,e,s,r){super(`Http error ${t}: ${e}`),this.statusCode=t,this.statusText=e,this.responseBody=s,this.response=r}}const u={API_URL:"https://api.openweathermap.org",API_KEY:"11cdf37009d6cf0b79c8c8a1094ec724"};class C{constructor({baseUrl:t,headers:e,apiKey:s}){a(this,"baseUrl");a(this,"defaultHeaders");a(this,"apiKey");this.baseUrl=t,this.defaultHeaders=e||{},this.apiKey=s}async request(t,e={},s){const r=this.baseUrl+t+(s?`&appid=${s}`:""),n={...this.defaultHeaders,...e.headers||{}},o=await fetch(r,{...e,headers:n}),c=await o.json();if(!o.ok)throw new h(o.status,o.statusText,c,o);return c}get(t,e={}){return this.request(t,{...e,method:"GET"},this.apiKey)}}const S=new C({baseUrl:u.API_URL,apiKey:u.API_KEY});class g{static async get(t){const e=encodeURIComponent(t.trim());return await S.get(`/data/2.5/forecast?q=${e}&units=metric&lang=ru`)}}class x extends l{constructor(t){super("section","search"),this.onSearch=t}createElement(){this.element.innerHTML=` <form class="search__form" data-search-form>
        ...
        <p class="form-message" data-form-message></p>`,this.element.querySelector("[data-search-form]").addEventListener("submit",this.handleSubmit.bind(this))}async handleSubmit(t){t.preventDefault();const e=this.element.querySelector("[data-search-input]"),s=this.element.querySelector("[data-form-message]");if(e.value.trim().length===0){s.textContent="Проверка на дурака прошла успешно";return}try{const r=await g.get(e.value.trim());console.log(r),this.onSearch(r),localStorage.setItem("currentCity",e.value.trim())}catch(r){r instanceof h&&(s.textContent="Сорян, не смог найти твой город :( вот текст ошибки если шаришь: "+r.message)}}render(){return this.createElement(),this.element}}function p(i){const t=new Date(i*1e3),e=t.getHours().toString().padStart(2,"0"),s=t.getMinutes().toString().padStart(2,"0");return`${e}:${s}`}class m extends l{constructor(t=null){super("section","current"),this.data=t}async createElement(){if(!this.data){this.element.innerHTML="<p>Ошибка загрузки данных</p>";return}const t=this.data.list.find(s=>s.pop&&s.pop>0),e=t?`${Math.ceil(t.pop*100)}%`:"Нет данных о вероятности дождя";this.element.innerHTML=`
...
`}render(){return this.createElement(),this.element}}class E extends b{constructor(){super("main");a(this,"data",null)}async getDataFromLocalstorage(){try{const e=localStorage.getItem("currentCity");if(!e)return;const s=await g.get(e);if(!s)return;this.data=s}catch(e){e instanceof h&&console.error(e.message)}}async createPage(){const e=this.element.querySelector(".container");this.appendSearch(e),await this.getDataFromLocalstorage(),this.data&&this.appendCurrentWeather(e)}updateCurrentWeather(e){const s=e.querySelector(".current");s&&s.remove(),this.data&&e.append(new m(this.data).render())}appendSearch(e){const s=new x(r=>{this.data=r,this.updateCurrentWeather(e)});e.append(s.render())}async appendCurrentWeather(e){e.append(new m(this.data).render())}async render(){return await this.createPage(),this.element}}class L extends l{constructor(){super("div","settings-window","data-settings-modal")}createElement(){this.element.innerHTML=`
      <div class="settings-window__content">
        ...
        <button class="close-settings" data-close-settings-modal>
          ...
          `}render(){return this.createElement(),this.element}}class M{constructor(){a(this,"root");this.root=document.querySelector("[data-app]")}async init(){this.root.append(new f().render()),this.root.append(await new E().render()),this.root.append(new L().render()),new _("[data-settings-modal]","[data-open-settings-modal]","[data-close-settings-modal]","settings-window--active","no-scroll").init()}}new M().init();
